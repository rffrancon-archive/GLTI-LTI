"""
The original version of the Logbook class comes from the DEAP framework:
https://github.com/DEAP/deap
Modification have been made to the original so that python3 is supported.
"""
...
def disp_tree(tree):
    """Displays a tree graphically using igraph."""
